...
import com.jjr8112.mall.front_end.service.PmsFrontEndProductService;
 ...
 */
@Service
public class PmsFrontEndProductServiceImpl implements PmsFrontEndProductService {
    @Autowired
    ...
    @Autowired
    private FrontEndProductDao portalProductDao;
    ...
    @Override
    public PmsFrontEndProductDetail detail(Long id) {
        PmsFrontEndProductDetail result = new PmsFrontEndProductDetail();
        //获取商品信息
