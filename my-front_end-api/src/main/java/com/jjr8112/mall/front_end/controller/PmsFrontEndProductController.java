...
public class PmsFrontEndProductController {
    ...
    @Autowired
    private PmsFrontEndProductService portalProductService;
    ...
    @ResponseBody
    public CommonResult<PmsFrontEndProductDetail> detail(@PathVariable Long id) {
        PmsFrontEndProductDetail productDetail = portalProductService.detail(id);
